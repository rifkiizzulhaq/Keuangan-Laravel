                            ...
                            @foreach ($komponen_program as $item)
                                <tr>
                                    <td class="h-px w-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <span
                                                class="text-sm text-gray-600 dark:text-gray-400">{{ $item->kode ?? '' }}</span>
                                        </div>
                                    </td>
                                    <td class="h-px w-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        <div class="px-6 py-2 flex ">
                                            ...
                                            <form method="POST" action="{{ route('destroy_program',['id' => $item->id]) }}">
                                                @csrf
                                                @method('DELETE')
